...
import type { EventRecord, EventsResponse, JsonValue } from "@/lib/dashboard/types";
    ...
    <div className="space-y-6">
      <section className="rounded-[10px] border border-[var(--border)] bg-white p-6">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-[var(--text-secondary)]">
          Review messages, timestamps, related event IDs, and metadata previews across all operational streams.
        </p>
      </section>
